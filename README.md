...
### Heroku Base URL -
  - This project is hosted on Heroku and it's base url is - https://car-rental-wp.herokuapp.com/ . **POSTMAN** has been used to test all the endpoints of API. 
...
### How to run the application ?
  Open the POSTMAN collection and execute the sample requests for each of the 6 endpoints discussed above.
